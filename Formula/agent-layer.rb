class AgentLayer < Formula
  ...
  url "https://github.com/conn-castle/agent-layer/releases/download/v0.5.1/agent-layer-0.5.1.tar.gz"
  sha256 "edbed54c9d4b7981d345b551b38633e10a0f53447e0dadd32ef38f0cc6b5819f"
  license "MIT"
