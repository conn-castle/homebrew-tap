class AgentLayer < Formula
  ...
  url "https://github.com/conn-castle/agent-layer/releases/download/v0.6.0/agent-layer-0.6.0.tar.gz"
  sha256 "17ba2777d2d2800170bd4a17528521d2f370ef52ef779451ed01b658ae69898e"
  license "MIT"
